...
namespace HMI.Main.Symbols.Model
{
	...
	partial class sDefault
	{
		...
		private void InitializeComponent()
		{
			...
			// rectangle1
			// 
			this.rectangle1.Bounds = new NxtControl.Drawing.RectF(((float)(12D)), ((float)(220D)), ((float)(150D)), ((float)(50D)));
			...
			// pusher
			// 
			this.pusher.Bounds = new NxtControl.Drawing.RectF(((float)(137D)), ((float)(236D)), ((float)(140D)), ((float)(30D)));
			...
			this.TransArm.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, 477D, 202D);
			this.TransArm.Name = "TransArm";
			this.TransArm.EndInit();
			// 
			// rectangle3
			// 
			this.rectangle3.Bounds = new NxtControl.Drawing.RectF(((float)(427D)), ((float)(186D)), ((float)(100D)), ((float)(85D)));
			...
			// rectangle4
			// 
			this.rectangle4.Bounds = new NxtControl.Drawing.RectF(((float)(165D)), ((float)(45D)), ((float)(66D)), ((float)(188D)));
			...
			// wp1
			// 
			this.wp1.Bounds = new NxtControl.Drawing.RectF(((float)(168D)), ((float)(206D)), ((float)(60D)), ((float)(30D)));
			...
			this.PosPusher.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, double.NaN, double.NaN);
			this.PosPusher.IsOnlyInput = true;
			this.PosPusher.Location = new NxtControl.Drawing.PointF(double.NaN, double.NaN);
			this.PosPusher.Name = "PosPusher";
			this.PosPusher.Size = new NxtControl.Drawing.SizeF(double.NegativeInfinity, double.NegativeInfinity);
			...
			this.AngleTransUnit.DesignMatrix = new NxtControl.Drawing.Matrix2D(0.87D, 0D, 0D, 1D, double.NaN, double.NaN);
			this.AngleTransUnit.IsOnlyInput = true;
			this.AngleTransUnit.Location = new NxtControl.Drawing.PointF(double.NaN, double.NaN);
			this.AngleTransUnit.Name = "AngleTransUnit";
			this.AngleTransUnit.Size = new NxtControl.Drawing.SizeF(double.NegativeInfinity, double.NegativeInfinity);
			...
			// ellipse1
			// 
			this.ellipse1.Bounds = new NxtControl.Drawing.RectF(((float)(641D)), ((float)(196D)), ((float)(14D)), ((float)(14D)));
			this.ellipse1.Font = new NxtControl.Drawing.Font("Arial", 8F, System.Drawing.FontStyle.Regular);
			this.ellipse1.Name = "ellipse1";
			// 
			// rectangle2
			// 
			this.rectangle2.Bounds = new NxtControl.Drawing.RectF(((float)(645D)), ((float)(200D)), ((float)(6D)), ((float)(30D)));
			this.rectangle2.Font = new NxtControl.Drawing.Font("Arial", 8F, System.Drawing.FontStyle.Regular);
			this.rectangle2.Name = "rectangle2";
			// 
			// polygon1
			// 
			this.polygon1.Bounds = new NxtControl.Drawing.RectF(((float)(637D)), ((float)(230D)), ((float)(22D)), ((float)(6D)));
			this.polygon1.Closed = true;
			this.polygon1.Font = new NxtControl.Drawing.Font("Arial", 8F, System.Drawing.FontStyle.Regular);
			this.polygon1.Name = "polygon1";
			this.polygon1.Points.AddRange(new NxtControl.Drawing.PointF[] {
			new NxtControl.Drawing.PointF(643D, 230D),
			new NxtControl.Drawing.PointF(637D, 236D),
			new NxtControl.Drawing.PointF(659D, 236D),
			new NxtControl.Drawing.PointF(653D, 230D)});
			// 
			// rectangle5
			// 
			this.rectangle5.Bounds = new NxtControl.Drawing.RectF(((float)(164D)), ((float)(234D)), ((float)(192D)), ((float)(34D)));
			...
			// 
			this.wp1X.BeginInit();
			this.wp1X.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, double.NaN, double.NaN);
			this.wp1X.IsOnlyInput = true;
			this.wp1X.Location = new NxtControl.Drawing.PointF(double.NaN, double.NaN);
			this.wp1X.Name = "wp1X";
			this.wp1X.Size = new NxtControl.Drawing.SizeF(double.NegativeInfinity, double.NegativeInfinity);
			...
			// 
			this.wp1Y.BeginInit();
			this.wp1Y.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, double.NaN, double.NaN);
			this.wp1Y.IsOnlyInput = true;
			this.wp1Y.Location = new NxtControl.Drawing.PointF(double.NaN, double.NaN);
			this.wp1Y.Name = "wp1Y";
			this.wp1Y.Size = new NxtControl.Drawing.SizeF(double.NegativeInfinity, double.NegativeInfinity);
			...
			// wp2
			// 
			this.wp2.Bounds = new NxtControl.Drawing.RectF(((float)(168D)), ((float)(175D)), ((float)(60D)), ((float)(30D)));
			...
			// wp3
			// 
			this.wp3.Bounds = new NxtControl.Drawing.RectF(((float)(168D)), ((float)(144D)), ((float)(60D)), ((float)(30D)));
			...
			// wp4
			// 
			this.wp4.Bounds = new NxtControl.Drawing.RectF(((float)(168D)), ((float)(113D)), ((float)(60D)), ((float)(30D)));
			...
			// wp5
			// 
			this.wp5.Bounds = new NxtControl.Drawing.RectF(((float)(168D)), ((float)(82D)), ((float)(60D)), ((float)(30D)));
			...
			// wp6
			// 
			this.wp6.Bounds = new NxtControl.Drawing.RectF(((float)(168D)), ((float)(51D)), ((float)(60D)), ((float)(30D)));
			...
			// 
			this.wp2X.BeginInit();
			this.wp2X.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, double.NaN, double.NaN);
			this.wp2X.IsOnlyInput = true;
			this.wp2X.Location = new NxtControl.Drawing.PointF(double.NaN, double.NaN);
			this.wp2X.Name = "wp2X";
			this.wp2X.Size = new NxtControl.Drawing.SizeF(double.NegativeInfinity, double.NegativeInfinity);
			...
			// 
			this.wp2Y.BeginInit();
			this.wp2Y.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, double.NaN, double.NaN);
			this.wp2Y.IsOnlyInput = true;
			this.wp2Y.Location = new NxtControl.Drawing.PointF(double.NaN, double.NaN);
			this.wp2Y.Name = "wp2Y";
			this.wp2Y.Size = new NxtControl.Drawing.SizeF(double.NegativeInfinity, double.NegativeInfinity);
			...
			// 
			this.wp3X.BeginInit();
			this.wp3X.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, double.NaN, double.NaN);
			this.wp3X.IsOnlyInput = true;
			this.wp3X.Location = new NxtControl.Drawing.PointF(double.NaN, double.NaN);
			this.wp3X.Name = "wp3X";
			this.wp3X.Size = new NxtControl.Drawing.SizeF(double.NegativeInfinity, double.NegativeInfinity);
			...
			// 
			this.wp3Y.BeginInit();
			this.wp3Y.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, double.NaN, double.NaN);
			this.wp3Y.IsOnlyInput = true;
			this.wp3Y.Location = new NxtControl.Drawing.PointF(double.NaN, double.NaN);
			this.wp3Y.Name = "wp3Y";
			this.wp3Y.Size = new NxtControl.Drawing.SizeF(double.NegativeInfinity, double.NegativeInfinity);
			...
			// 
			this.wp4X.BeginInit();
			this.wp4X.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, double.NaN, double.NaN);
			this.wp4X.IsOnlyInput = true;
			this.wp4X.Location = new NxtControl.Drawing.PointF(double.NaN, double.NaN);
			this.wp4X.Name = "wp4X";
			this.wp4X.Size = new NxtControl.Drawing.SizeF(double.NegativeInfinity, double.NegativeInfinity);
			...
			// 
			this.wp4Y.BeginInit();
			this.wp4Y.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, double.NaN, double.NaN);
			this.wp4Y.IsOnlyInput = true;
			this.wp4Y.Location = new NxtControl.Drawing.PointF(double.NaN, double.NaN);
			this.wp4Y.Name = "wp4Y";
			this.wp4Y.Size = new NxtControl.Drawing.SizeF(double.NegativeInfinity, double.NegativeInfinity);
			...
			// 
			this.wp5X.BeginInit();
			this.wp5X.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, double.NaN, double.NaN);
			this.wp5X.IsOnlyInput = true;
			this.wp5X.Location = new NxtControl.Drawing.PointF(double.NaN, double.NaN);
			this.wp5X.Name = "wp5X";
			this.wp5X.Size = new NxtControl.Drawing.SizeF(double.NegativeInfinity, double.NegativeInfinity);
			...
			// 
			this.wp5Y.BeginInit();
			this.wp5Y.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, double.NaN, double.NaN);
			this.wp5Y.IsOnlyInput = true;
			this.wp5Y.Location = new NxtControl.Drawing.PointF(double.NaN, double.NaN);
			this.wp5Y.Name = "wp5Y";
			this.wp5Y.Size = new NxtControl.Drawing.SizeF(double.NegativeInfinity, double.NegativeInfinity);
			...
			// 
			this.wp6X.BeginInit();
			this.wp6X.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, double.NaN, double.NaN);
			this.wp6X.IsOnlyInput = true;
			this.wp6X.Location = new NxtControl.Drawing.PointF(double.NaN, double.NaN);
			this.wp6X.Name = "wp6X";
			this.wp6X.Size = new NxtControl.Drawing.SizeF(double.NegativeInfinity, double.NegativeInfinity);
			...
			// 
			this.wp6Y.BeginInit();
			this.wp6Y.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, double.NaN, double.NaN);
			this.wp6Y.IsOnlyInput = true;
			this.wp6Y.Location = new NxtControl.Drawing.PointF(double.NaN, double.NaN);
			this.wp6Y.Name = "wp6Y";
			this.wp6Y.Size = new NxtControl.Drawing.SizeF(double.NegativeInfinity, double.NegativeInfinity);
			...
			// rectangle6
			// 
			this.rectangle6.Bounds = new NxtControl.Drawing.RectF(((float)(0D)), ((float)(271D)), ((float)(731D)), ((float)(39D)));
			...
			// rectangle7
			// 
			this.rectangle7.Bounds = new NxtControl.Drawing.RectF(((float)(337D)), ((float)(251D)), ((float)(15D)), ((float)(15D)));
			...
			// rectangle9
			// 
			this.rectangle9.Bounds = new NxtControl.Drawing.RectF(((float)(610D)), ((float)(266D)), ((float)(120D)), ((float)(3D)));
			...
			this.mgzEmpty.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, 197D, 251D);
			this.mgzEmpty.FrameSize = 33F;
			this.mgzEmpty.IsOnlyInput = true;
			...
			this.vcmON.DesignMatrix = new NxtControl.Drawing.Matrix2D(1D, 0D, 0D, 1D, 648D, 203D);
			this.vcmON.FrameSize = 33F;
			this.vcmON.IsOnlyInput = true;
			...
			this.mgzEmpty,
			this.vacum});
			this.SymbolSize = new System.Drawing.Size(730, 336);
