...
namespace HMI.Main.Symbols.BasicSKILL
{
	...
	partial class sDefault
	{
		...
		private void InitializeComponent()
		{
			...
			this.NAME = new System.HMI.Symbols.Base.Label();
			...
			this.NAME.Brush = new NxtControl.Drawing.Brush("TextBoxBrush");
			this.NAME.DesignMatrix = new NxtControl.Drawing.Matrix2D(2.4D, 0D, 0D, 1.9047619047619047D, 96D, 408D);
			this.NAME.FontScale = false;
			this.NAME.IsOnlyInput = true;
			this.NAME.Name = "NAME";
			this.NAME.Pen = new NxtControl.Drawing.Pen("LabelPen");
			this.NAME.TagName = "NAME";
			this.NAME.EndInit();
			// 
			// drawnTextBox1
			// 
			this.drawnTextBox1.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
			this.drawnTextBox1.Bounds = new NxtControl.Drawing.RectF(((float)(616D)), ((float)(88D)), ((float)(160D)), ((float)(25D)));
		...
		private System.HMI.Symbols.Base.Label NAME;
